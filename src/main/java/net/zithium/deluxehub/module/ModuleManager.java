...
import net.zithium.deluxehub.module.modules.chat.AutoBroadcast;
import net.zithium.deluxehub.module.modules.chat.ChatCommandBlock;
import net.zithium.deluxehub.module.modules.chat.ChatLock;
import net.zithium.deluxehub.module.modules.chat.CustomCommands;
...
import net.zithium.deluxehub.module.modules.player.DoubleJump;
import net.zithium.deluxehub.module.modules.player.PlayerListener;
import net.zithium.deluxehub.module.modules.player.PlayerOffHandSwap;
...
import net.zithium.deluxehub.module.modules.visual.tablist.TablistManager;
import net.zithium.deluxehub.module.modules.world.AntiWorldDownloader;
import net.zithium.deluxehub.module.modules.world.Launchpad;
import net.zithium.deluxehub.module.modules.world.LobbySpawn;
import net.zithium.deluxehub.module.modules.world.WorldProtect;
